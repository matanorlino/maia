        ...
        <div class="x_content">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
              <div class="board" id="eboard" style="width: 100% !important; height: 500px;"></div>  
              <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                <p>Select your presentation here</p>
                <select id="cb-ppt" class="select2 form-control">
                ...
                <div>
                  <div class="txt-center">
                    ...
                    <a href="#" class="ppt-dl blk">Download File</a>
                  </div>
                </div>
              </div>
              <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                ...
                <div class="txt-center clearfix">
                  <video class="txt-center" width="320" height="240" controls></video>
                </div>
              ...
              <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                ...
                <select id="cb-pdf" class="select2 col-md-8" style="width: 100% !important;"></select></p><br>
                ...
                <div class="txt-center">
                  ...
                  <a href="#" class="act-dl blk">Download File</a>
                </div>
                </div>
              </div>
